...
// Keep display always on (0 disables screen timeout/screensaver).
#define USERPREFS_CONFIG_DISPLAY_SCREEN_ON_SECS 0

// #define USERPREFS_CONFIG_GPS_MODE meshtastic_Config_PositionConfig_GpsMode_ENABLED

// Temperature-to-LED color mapping thresholds (Celsius).
// Blue at or below COLD, red at or above HOT, green in the middle.
#define USERPREFS_TEMP_LED_COLD_C 25.0f   // below 25°C = blue (cool/idle server)
#define USERPREFS_TEMP_LED_HOT_C  55.0f   // above 55°C = red (hot exhaust); green at 40°C
#define USERPREFS_TEMP_LED_BRIGHTNESS 1   // 0-255; ultra-low to reduce current draw and avoid POE brownouts
