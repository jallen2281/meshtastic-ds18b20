...
#define meshtastic_EnvironmentMetrics_has_multiple_temperatures_tag 2
#define meshtastic_EnvironmentMetrics_has_temperature1_tag 3
#define meshtastic_EnvironmentMetrics_temperature1_tag 4
#define meshtastic_EnvironmentMetrics_has_temperature2_tag 5
#define meshtastic_EnvironmentMetrics_temperature2_tag 6
#define meshtastic_EnvironmentMetrics_has_temperature3_tag 7
#define meshtastic_EnvironmentMetrics_temperature3_tag 8
#define meshtastic_EnvironmentMetrics_has_temperature4_tag 9
#define meshtastic_EnvironmentMetrics_temperature4_tag 10
#define meshtastic_EnvironmentMetrics_has_temperature5_tag 11
#define meshtastic_EnvironmentMetrics_temperature5_tag 12
#define meshtastic_EnvironmentMetrics_has_temperature6_tag 13
#define meshtastic_EnvironmentMetrics_temperature6_tag 14
#define meshtastic_EnvironmentMetrics_relative_humidity_tag 15
#define meshtastic_EnvironmentMetrics_barometric_pressure_tag 16
#define meshtastic_EnvironmentMetrics_gas_resistance_tag 17
#define meshtastic_EnvironmentMetrics_voltage_tag 18
#define meshtastic_EnvironmentMetrics_current_tag 19
#define meshtastic_EnvironmentMetrics_iaq_tag    20
#define meshtastic_EnvironmentMetrics_distance_tag 21
#define meshtastic_EnvironmentMetrics_lux_tag    22
#define meshtastic_EnvironmentMetrics_white_lux_tag 23
#define meshtastic_EnvironmentMetrics_ir_lux_tag 24
#define meshtastic_EnvironmentMetrics_uv_lux_tag 25
#define meshtastic_EnvironmentMetrics_wind_direction_tag 26
#define meshtastic_EnvironmentMetrics_wind_speed_tag 27
#define meshtastic_EnvironmentMetrics_weight_tag 28
...
X(a, STATIC,   SINGULAR, BOOL,     has_multiple_temperatures,   2) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature1,  3) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature1,      4) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature2,  5) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature2,      6) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature3,  7) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature3,      8) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature4,  9) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature4,     10) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature5, 11) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature5,     12) \
X(a, STATIC,   SINGULAR, BOOL,     has_temperature6, 13) \
X(a, STATIC,   OPTIONAL, FLOAT,    temperature6,     14) \
X(a, STATIC,   OPTIONAL, FLOAT,    relative_humidity,   15) \
X(a, STATIC,   OPTIONAL, FLOAT,    barometric_pressure,   16) \
X(a, STATIC,   OPTIONAL, FLOAT,    gas_resistance,   17) \
X(a, STATIC,   OPTIONAL, FLOAT,    voltage,         18) \
X(a, STATIC,   OPTIONAL, FLOAT,    current,         19) \
X(a, STATIC,   OPTIONAL, UINT32,   iaq,             20) \
X(a, STATIC,   OPTIONAL, FLOAT,    distance,        21) \
X(a, STATIC,   OPTIONAL, FLOAT,    lux,             22) \
X(a, STATIC,   OPTIONAL, FLOAT,    white_lux,       23) \
X(a, STATIC,   OPTIONAL, FLOAT,    ir_lux,          24) \
X(a, STATIC,   OPTIONAL, FLOAT,    uv_lux,          25) \
X(a, STATIC,   OPTIONAL, UINT32,   wind_direction,  26) \
X(a, STATIC,   OPTIONAL, FLOAT,    wind_speed,      27) \
...
#define meshtastic_EnvironmentMetrics_size       92
#define meshtastic_HealthMetrics_size            11
#define meshtastic_LocalStats_size               60
#define meshtastic_Nau7802Config_size            16
#define meshtastic_PowerMetrics_size             30
#define meshtastic_Telemetry_size                99
