...
meshtastic_CriticalErrorCode error_code = meshtastic_CriticalErrorCode_NONE;
...
#ifdef USERPREFS_CONFIG_DISPLAY_SCREEN_ON_SECS
    config.display.screen_on_secs = USERPREFS_CONFIG_DISPLAY_SCREEN_ON_SECS;
#endif
