        ...
        case meshtastic_PortNum_TELEMETRY_APP: {
            ...
            if (pb_decode_from_bytes(mp->decoded.payload.bytes, mp->decoded.payload.size, &meshtastic_Telemetry_msg, &scratch)) {
                ...
                if (decoded->which_variant == meshtastic_Telemetry_device_metrics_tag) {
                    ...
                    msgPayload["temperature1"] = new JSONValue(decoded->variant.environment_metrics.temperature1);
                    msgPayload["temperature2"] = new JSONValue(decoded->variant.environment_metrics.temperature2);
                    msgPayload["temperature3"] = new JSONValue(decoded->variant.environment_metrics.temperature3);
